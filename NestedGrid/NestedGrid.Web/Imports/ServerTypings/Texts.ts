namespace NestedGrid.Texts {
    ...
    declare namespace Db {
        ...
        namespace Default {
            ...
            namespace ChildA {
                export const Id: string;
                export const MainId: string;
                export const MainName: string;
                export const Name: string;
            }

            namespace ChildB {
                export const ChildAId: string;
                export const ChildAMainId: string;
                export const ChildAName: string;
                export const Id: string;
                export const Name: string;
            }
